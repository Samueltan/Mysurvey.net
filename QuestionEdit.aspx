<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuestionEdit.aspx.cs" Inherits="QuestionEdit" %>
...
<!--=======form=======-->
                         <form id="surveyform" runat="server">
                            ...
                            <input type="submit" name="yt0" value="Save Changes" onclick="savechange()" />                    
                            <a id="backtosurvey" class="button" href="Homepage.aspx">Back to all Surveys</a>
                            </div>
                            <div class="row">
...
<!--======== questions template=======-->
                            ...
                            <div class="row buttons" id="add-new-question">
                                <a id="addnewq" class="button" href="#">Add New Question</a>
                            </div>
        ...
        <!--======== FOOTER ========-->
        <div id="footer">
            <p><a href="http://localhost:8089/mySurvey/mySurvey_app/contact">Contact Us
                </a></p>
        </div><!-- footer -->
    </div><!-- page -->
